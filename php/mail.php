...
function sendmail($to, $content, $title) {
    ...
    $mail->FromName = 'Trisolaris邮件姬';

    //smtp登录的账号 这里填入字符串格式的qq号即可
    $mail->Username ='zhanshugegpu@163.com';

    //smtp登录的密码 使用生成的授权码（就刚才叫你保存的最新的授权码）
    $mail->Password = 'Trisolaris233';//163邮箱也有授权码 进入163邮箱帐号获取

    //设置发件人邮箱地址 这里填入上述提到的“发件人邮箱”
    $mail->From = 'zhanshugegpu@163.com';
